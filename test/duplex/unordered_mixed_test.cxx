...
public:
    ...
    initiator_slave(bin::endpoint_id id, bdu::perf_params&& params);
    ~initiator_slave();
...
initiator_slave::initiator_slave(bin::endpoint_id id, bdu::perf_params&& params) :
	id_(id),
	thread_(nullptr),
	service_(),
	strand_(service_),
	...
	handlers_(
	{
	    ...
	    [&](const in_connection_type&, bmc::payload<bdu::UnreliableMsg>&& payload)
	    {
	    ...
	    [&](const in_connection_type&, bmc::payload<bdu::ReliableMsg>&& payload)
	    {
...
initiator_slave::unreliable_queue_type::consumer::result initiator_slave::try_receive_unreliable(bmc::payload<bdu::UnreliableMsg>& output)
{
    return unreliable_in_consumer_.try_dequeue_move(output);
}

initiator_slave::reliable_queue_type::consumer::result initiator_slave::try_receive_reliable(bmc::payload<bdu::ReliableMsg>& output)
{
...
{
    bmc::payload<bdu::UnreliableMsg> message;
...
{
    bmc::payload<bdu::ReliableMsg> message;
...
public:
    ...
    responder_master(bin::endpoint_id&& point, bdu::perf_params&& params);
    ~responder_master();
    void bind(bin::endpoint_id&& point);
    void send_unreliable(const bin::endpoint_id& point, bmc::form<bdu::UnreliableMsg>& message);
    void send_reliable(const bin::endpoint_id& point, bmc::form<bdu::ReliableMsg>& message);
    asio::io_service service;
    asio::io_service::strand strand;
    bme::buffer_pool pool;
    responder_type responder;
    std::unordered_set<bin::endpoint_id> known_endpoints;
private:
    typedef turbo::container::spsc_ring_queue<bmc::payload<bdu::UnreliableMsg>> unreliable_queue_type;
    typedef turbo::container::spsc_ring_queue<bmc::payload<bdu::ReliableMsg>> reliable_queue_type;
    void on_send_unreliable(bin::endpoint_id point, std::function<out_connection_type*(const beam::internet::endpoint_id&)> find);
    void on_send_reliable(bin::endpoint_id point, std::function<out_connection_type*(const beam::internet::endpoint_id&)> find);
    unreliable_queue_type unreliable_in_queue_;
    reliable_queue_type reliable_in_queue_;
    unreliable_queue_type unreliable_out_queue_;
    reliable_queue_type reliable_out_queue_;
...
responder_master::responder_master(bin::endpoint_id&& point, bdu::perf_params&& params) :
	service(),
	strand(service),
...
void responder_master::bind(bin::endpoint_id&& point)
{
    ASSERT_EQ(bdu::bind_result::success, responder.bind(point)) << "Bind failed";
}

void responder_master::send_unreliable(const bin::endpoint_id& point, bmc::form<bdu::UnreliableMsg>& message)
{
...
void responder_master::send_reliable(const bin::endpoint_id& point, bmc::form<bdu::ReliableMsg>& message)
{
...
void responder_master::on_send_unreliable(bin::endpoint_id point, std::function<out_connection_type*(const beam::internet::endpoint_id&)> find)
{
...
void responder_master::on_send_reliable(bin::endpoint_id point, std::function<out_connection_type*(const beam::internet::endpoint_id&)> find)
{
    out_connection_type* connection = find(point);
    if (connection != nullptr)
    {
...
void setupConnection(::responder_master& master, ::initiator_slave& slave)
{
	...
	master.responder.async_receive(
	{
	    ...
	    {
		master.known_endpoints.insert(in.get_source_id());
		++connection_count;
	    },
	    ...
	    [&](const ::responder_master::in_connection_type&, bmc::payload<bdu::UnreliableMsg>&&)
	    {
...
{
    ::responder_master master(bin::endpoint_id(0U, 18801U), {24U, 64U});
	...
	master.responder.async_receive(
	{
	    [&](const ::responder_master::in_connection_type::event_handlers& current)
	    {
		bmc::form<bdu::UnreliableMsg> message(std::move(master.pool.borrow()), master.responder.get_binding());
...
{
    ::responder_master master(bin::endpoint_id(0U, 18802U), {24U, 64U});
    ::initiator_slave slave({::localhost, 18802U}, {24U, 64U});
    setupConnection(master, slave);
    bmc::form<bdu::ReliableMsg> message(std::move(master.pool.borrow()), master.responder.get_binding());
...
{
    ::responder_master master(bin::endpoint_id(0U, 18803U), {24U, 64U});
    ::initiator_slave slave({::localhost, 18803U}, {24U, 64U});
    setupConnection(master, slave);
    bmc::form<bdu::ReliableMsg> message1(std::move(master.pool.borrow()), master.responder.get_binding());
    bdu::ReliableMsg::Builder builder1 = message1.build();
    builder1.setValue("bar");
    slave.send_reliable(message1);
    bmc::form<bdu::UnreliableMsg> message2(std::move(master.pool.borrow()), master.responder.get_binding());
...
{
    ::responder_master master(bin::endpoint_id(0U, 18901U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 18902U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 18903U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 19001U), {24U, 64U});
	...
	[&](const ::responder_master::in_connection_type&, bmc::payload<bdu::UnreliableMsg>&& payload)
	{
	    ...
	    auto iter = master.known_endpoints.begin();
	    bmc::form<bdu::UnreliableMsg> reply(std::move(master.pool.borrow()), master.responder.get_binding());
...
{
    ::responder_master master(bin::endpoint_id(0U, 19002U), {24U, 64U});
	...
	[&](const ::responder_master::in_connection_type&, bmc::payload<bdu::ReliableMsg>&& payload)
	{
	    ...
	    auto iter = master.known_endpoints.begin();
	    bmc::form<bdu::ReliableMsg> reply(std::move(master.pool.borrow()), master.responder.get_binding());
...
{
    ::responder_master master(bin::endpoint_id(0U, 19003U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 19101U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 19102U), {24U, 64U});
...
{
    ::responder_master master(bin::endpoint_id(0U, 19103U), {24U, 64U});
